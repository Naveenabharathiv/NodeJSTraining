...
/*
read a file which is 20gb in length
    readFileSync() -- NO -- blocking I/O model
    readFile() -- No -- because its a big file  and the entire file is read on a single shot
    read() -- No -- because its a big file and the entire file is read on a single shot myBuffer -- 20gb
    createReadStream() -- Best way
    Streams 
        -- Input stream
        -- Output stream
